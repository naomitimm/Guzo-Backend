...
router
	.route("/")
	.get(protect, restrictTo(1), getAllRestaurantBooking)
	.post(protect, createRestaurantBooking);
router
	.route("/:id")
	.get(protect, getRestaurantBooking)
	.patch(protect, updateRestaurantBooking)
	.delete(protect, deleteRestaurantBooking);

export { router as restaurantBooking };
